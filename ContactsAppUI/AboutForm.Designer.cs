namespace ContactsApp
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Author: Vladimir Shvoev";
			// 
			// label4
			// 
			...
			this.linkLabel1.Text = "shvoev.work@gmail.com";
			// 
			// label5
			// 
			...
			this.linkLabel2.Text = "https://github.com/Vanada1";
			// 
			// label6
			// 
			...
			this.label6.Text = "2020 Vladimir Shvoev ";
			// 
			// About
			// 
